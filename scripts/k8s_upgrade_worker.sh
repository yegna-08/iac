#!/usr/bin/env bash
# Upgrading K8s worker node to latest stable 1.20 version
...
echo -e "> Upgrading the local kubelet configuration for worker node:...\n"
...
#
echo -e "\n Worker Node ${HOSTNAME} \e[32msuccessfuly\e[0m upgraded\n"